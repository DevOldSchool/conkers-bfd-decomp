...
- Matched for active target: **328**
- Remaining: **4898**
- Completed source units: **48 / 716**
- Mixed C/ASM source units in the canonical build: **666**
- Functions awaiting reviewed source-unit boundaries: **0**
- Matched function bytes for active target: **159,368 / 2,237,392 (7.1229%)**
- Fully matched source-unit bytes: **151,112 / 2,237,392 (6.7539%)**
...
| --- | ---: | ---: | ---: | ---: |
| US | 159,368 | 151,112 | 2,237,392 | 7.1229% |
...
| Game overlay | 5224 | 327 | 60,688 | 52,432 | 2,072,880 | 2.9277% |
