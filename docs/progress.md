...
- Matched for active target: **42**
- Remaining: **386**
- Completed source units: **0 / 129**
- Mixed C/ASM source units in the canonical build: **127**
- Functions awaiting reviewed source-unit boundaries: **0**
- Matched function bytes for active target: **1,596 / 2,237,392 (0.0713%)**
...
| Game overlay | 426 | 41 | 1,428 | 0 | 2,072,880 | 0.0689% |
