...
- Remaining: **318**
- Completed source units: **34 / 129**
- Mixed C/ASM source units in the canonical build: **93**
- Functions awaiting reviewed source-unit boundaries: **0**
- Matched function bytes for active target: **4,260 / 2,237,392 (0.1904%)**
- Fully matched source-unit bytes: **1,672 / 2,237,392 (0.0747%)**
...
| --- | ---: | ---: | ---: | ---: |
| US | 4,260 | 1,672 | 2,237,392 | 0.1904% |
