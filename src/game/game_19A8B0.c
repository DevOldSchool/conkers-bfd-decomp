...
#if 0 /* CONKER_DEFERRED_CANDIDATE func_1516ECAC CURRENT (1540) */
s32 func_1516ECAC(void *arg0) {
    s32 temp_t4;
    u8 var_v1;

    var_v1 = *(u8 *)((u8 *)arg0 + 0x1F);
    if (*(u8 *)((u8 *)arg0 + 0x24) != 0) {
        if (var_v1 != 0xFF) {
            ...
            *(u8 *)((u8 *)arg0 + 0x1F) = var_v1;
        }
    } else if (var_v1 != 0) {
        var_v1 -= D_800BE9E4 * *(u8 *)((u8 *)arg0 + 0x26);
        if ((s32) var_v1 < 0) {
            var_v1 = 0;
        }
        *(u8 *)((u8 *)arg0 + 0x1F) = var_v1;
    }
    if ((*(u8 *)((u8 *)arg0 + 0x24) == 0) && (var_v1 == 0)) {
        return 1;
    }
    temp_t4 = (s32) (((*(u8 *)((u8 *)arg0 + 0x2C) << 8) | *(u8 *)((u8 *)arg0 + 0x2D)) * var_v1) >> 7;
    *(s16 *)((u8 *)arg0 + 0x16) = (s16) temp_t4;
    *(s16 *)((u8 *)arg0 + 0x14) = (s16) temp_t4;
    return 0;
}
#endif /* CONKER_DEFERRED_CANDIDATE func_1516ECAC */
...
f32 func_150489B0(s32);
f32 func_15048A40(s32);
s32 func_150ADA20(s32);

#if 0 /* CONKER_DEFERRED_CANDIDATE func_15170034 CURRENT (1446) */
void func_15170034(s32 arg0, f32 *arg1, f32 *arg2, f32 *arg3) {
    ...
    sp2C = var_a1;
    sp2C = var_a1;
    sp1C = func_150ADA20(arg0) & var_a1;
    *arg2 = func_150489B0(sp1C & 0xFF);
    sp20 = func_15048A40(*(u8 *)((u8 *)&sp1C + 3));
    sp1C = func_150ADA20(sp1C & 0xFF) & 0xFF;
    sp24 = func_150489B0(sp1C & 0xFF);
    *arg1 = sp20 * func_15048A40(*(u8 *)((u8 *)&sp1C + 3));
    *arg3 = sp20 * sp24;
}
#endif /* CONKER_DEFERRED_CANDIDATE func_15170034 */
