...
#if 0 /* CONKER_DEFERRED_CANDIDATE func_15005FB0 CURRENT (65) */
...
#endif /* CONKER_DEFERRED_CANDIDATE func_15005FB0 */
#pragma GLOBAL_ASM("asm/nonmatchings/game_33460/func_15005FB0.s")
