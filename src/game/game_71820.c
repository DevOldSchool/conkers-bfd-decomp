...
s32 func_15045F8C(Game71820XZ *, f32, void *, u8 *); /* extern */

#if 0 /* CONKER_DEFERRED_CANDIDATE func_15045780 CURRENT (966) */
s32 func_15045780(Game71820XZ *arg0, u16 arg1, f32 arg2, u8 *arg3) {
    s32 sp1C;
    s32 sp18;

    if (*(f32 *)((u8 *)arg0 + 4) < arg2) {
        arg3[0x1C] = (u8)(arg3[0x1C] & 0xFFFD);
        return 0;
    }
    func_15045714(arg0, arg1 & 0xFFFF, &sp1C, (s32) &sp18);
    return func_15045F8C(arg0, arg2, &sp18, arg3);
}
#endif /* CONKER_DEFERRED_CANDIDATE func_15045780 */
#pragma GLOBAL_ASM("asm/nonmatchings/game_71820/func_15045780.s")
s32 func_15045780(Game71820XZ *, u16, f32, u8 *);   /* extern */
