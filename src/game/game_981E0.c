...
void func_1506B634(s32 arg0) {
    ...
    if (temp_a1[0x16] != 0) {
        ...
        *(s16 *)(temp_a1 + 0xE) = D_80099ABC[var_a0];
    } else {
        *(s16 *)(temp_a1 + 0xE) = D_80099AB4[temp_hi & 0xFF];
    }
    if (*(u16 *)(*(u8 **)(D_800D154C + 0x31C) + 0xE) == 0xA7) {
        D_800D1580 = 0xFF020144;
        *(s8 *)(*(u8 **)(D_800D154C + 0x31C) + 0xC) =
            (func_150ADA20() % 3U) + 2;
        func_1506E8D8();
...
void func_1507E7E4(u8 *, s32, s32, s32, s32);
extern f32 D_80099D48;

#if 0 /* CONKER_DEFERRED_CANDIDATE func_1506D584 CURRENT (465) */
void func_1506D584(void) {
    ...
    packed_ptr = &D_800D1580;
    if (D_800D154C[0x70] != 0x2A) {
        scale = *(f32 *)(*(u8 **)(D_800D154C + 0x2D0) + 0x10);
        packed = *packed_ptr;
        channel1 = (packed >> 24) & 0xFF;
        channel2 = packed >> 16;
        packed &= 0xFFFF;
        if (scale == 0.0f) {
            scale = D_80099D48;
        ...
        if (packed != 0xFFFF) {
            packed = (u32)((f32)(u32)packed / scale) & 0xFFFF;
        }
        func_1507E7E4(D_800D154C, channel1, channel2 & 0xFF, packed, 0);
    }
}
...
void func_1506D74C(void) {
    ...
    *(f32 *)(D_800D154C + 0x1C) += sp30;
    D_800D154C[0x100] |= 2;
    *(f32 *)(D_800D154C + 0x28) = 0.0f;
    D_800D154C[0x83] = 0x14;
...
extern u8 D_800CC37B;
extern u8 D_800CC3D1;
...
void func_1506D958(void) {
    ...
    if ((D_800CC2D0 != 0) && (temp_v0 == D_800CC37B) &&
        ((D_800C3E78 + 1) == D_800CC335)) {
        D_800CC3D1 = (D_800CC3D1 & 0xFFFE) | temp_t6;
        return;
    }
    var_a1 = &D_800CC5FC;
loop_5:
        ...
        var_a1 += 0x196;
    if (var_a1 == &D_800D121C) {
        return;
    }
    goto loop_5;
}
#endif /* CONKER_DEFERRED_CANDIDATE func_1506D958 */
...
#if 0 /* CONKER_DEFERRED_CANDIDATE func_1506E2CC CURRENT (1259) */
void func_1506E2CC(void) {
    ...
    if (*(s32 *)(actor + 0x1D4) != 0) {
        ...
        do {
            locals.y = 0.0f;
            actor = D_800D154C;
            func_150A7960(*(void **)(actor + 0x1D4), locals.x,
                            locals.y, locals.z,
                            &locals.x, &locals.y, &locals.z);
            locals.vertices[i][0] = locals.x;
            locals.vertices[i][1] = height;
            locals.vertices[i][2] = locals.z;
            if (i == 0) {
                locals.x = -boundary;
                locals.z = boundary;
            } else if (i == 1) {
        ...
        actor = D_800D154C;
        func_151700D8(&locals.vertices[0][0], *(f32 *)(actor + 0x14),
                       *(f32 *)(actor + 0x1C), 5,
                       *(f32 *)(actor + 0x14C) * 0.5f, 0, 4, 4, 0xFF, 0);
    }
}
#endif /* CONKER_DEFERRED_CANDIDATE func_1506E2CC */
#pragma GLOBAL_ASM("asm/nonmatchings/game_981E0/func_1506E2CC.s")
s32 func_10010894(s32);
s32 func_100107F8(u8 *, s32 *);
s32 func_151F2CDC(u8 *, s32 *);
extern u8 *D_800BE5A8[];

#if 0 /* CONKER_DEFERRED_CANDIDATE func_1506E46C CURRENT (3639) */
s32 func_1506E46C(u8 *arg0, s32 *arg1, s32 arg2) {
    s32 sp28;
    u32 sp18;
    s32 temp_t4;
    s32 temp_t8;
    ...
    var_a3 = *arg1;
    temp_v1 = var_a3 & 0x7FFF;
    if (var_a3 & 0x200000) {
        switch (arg2) {
        case 0:
            sp18 = temp_v1;
            sp28 = var_a3;
            if (func_100107F8(arg0, arg1) != 0) {
                return 0;
            }
            goto block_11;
        case 1:
...
block_11:
        if (temp_v1 >= 0x7D0U) {
            temp_t4 = var_a3 & 0xFF200000;
            temp_v0 = *(s32 *)(D_800BE5A8[arg0[0x288]] + (temp_v1 * 4) - 0x1F40);
            if (temp_v0 == 0) {
                return 0;
            }
            if (temp_t4 != 0) {
                var_a3 = temp_t4 | (temp_v0 & 0xFFFFFF);
            } else {
                var_a3 = temp_t4 | temp_v0;
            }
            goto block_17;
        }
block_17:
        temp_v1_2 = (u32)var_a3 >> 16;
        if (temp_v1_2 != 0) {
            sp18 = temp_v1_2;
            sp28 = var_a3;
            temp_t8 = temp_v1_2 & 0x1F;
            if ((u32)((u32)var_a3 >> 24) >= (u32)(func_150ADA20() & 0xFF)) {
                temp_t9 = var_a3 & 0x7FFF;
                var_a3 = temp_t9;
                if (temp_t8 != 0) {
                    var_a3 = func_1000F568(temp_t9, temp_t8);
                }
                goto block_22;
            }
            return 0;
...
#endif /* CONKER_DEFERRED_CANDIDATE func_1506E46C */
...
void func_1506EA98(void) {
    ...
    if (temp_v0 != 0) {
        ...
        if ((s32)*(u8 *)((u8 *)temp_a1 + 0x13D) >= 0x64) {
            ...
            *(f32 *)((u8 *)temp_a1 + 0x20) = 40.0f;
            *(f32 *)((u8 *)temp_a1 + 0x24) = 6.0f;
            *(u8 *)((u8 *)temp_a1 + 0x65) = 0;
            *(u16 *)((u8 *)temp_a1 + 0x76) = *(u16 *)(temp_v1 + 0x7A);
            if (*(u8 *)((u8 *)temp_a1 + 4) == 0x20) {
                *(f32 *)((u8 *)temp_a1 + 0x20) = 0.0f;
                *(s32 *)((u8 *)temp_a1 + 0xF8) |= 0x200;
                *(f32 *)((u8 *)temp_a1 + 0x24) = 0.0f;
                *(f32 *)((u8 *)temp_a1 + 0x3C) = 0.0f;
            }
            *(u8 *)((u8 *)temp_a1 + 0x104) = 0xFE;
            *(u8 *)((u8 *)temp_a1 + 0x105) = 0;
            sp18 = temp_a1;
            sp27 = temp_t6;
            *(u8 *)((u8 *)temp_a1 + 0x106) = func_1505E7CC(0xC, temp_a1);
            *(u16 *)((u8 *)temp_a1 + 0x84) = 0xFFFF;
            *(f32 *)((u8 *)temp_a1 + 0x1CC) = D_80099DA0;
            func_1505E874(sp27, temp_a1);
            *(s32 *)((u8 *)temp_a1 + 0x25C) |= 0x40;
        }
        temp_v1 = D_800D154C;
        temp_v1[0x13C] = 0;
    }
...
void func_1506EBC0(void) {
    ...
    state = D_800D154C;
    temp_a0 = state[0x13C];
    index = (temp_a0 - 0x64) & 0xFF;
    if (temp_a0 == 0) {
        return;
    }
    temp_a0_2 = (u8 *)&D_800CC2D0 + (index * 0x32C);
...
#if 0 /* CONKER_DEFERRED_CANDIDATE func_1506EF5C CURRENT (190) */
void func_1506EF5C(void) {
    s32 temp_t6;
    s32 packed = D_800D1580;

    *(u16 *)((u8 *)D_800D154C + 0x282) = 0xFFFF;
    *(s8 *)((u8 *)D_800D154C + 0x276) = 5;
    temp_t6 = ((packed >> 0x10) & 0xFF) * 2;
    *(s8 *)((u8 *)(D_800D154C + temp_t6) + 0x284) = (s8) (packed >> 8);
    *(s8 *)((u8 *)(temp_t6 + D_800D154C) + 0x285) = (s8) packed;
}
...
#if 0 /* CONKER_DEFERRED_CANDIDATE func_15071D78 CURRENT (425) */
...
extern s32 D_800CC4E8;
extern s8 D_800CC502;

#if 0 /* CONKER_DEFERRED_CANDIDATE func_150727F0 CURRENT (4465) */
void func_150727F0(void) {
    volatile s32 *var_v1;

    var_v1 = &D_800CC5FC;
    if ((D_800CC2D0 != 0) && ((D_800C3E78 + 1) == D_800CC335)) {
        D_800CC4E8 = 0;
        D_800CC502 = (s8)D_800D1580;
    }
    do {
        if ((*var_v1 != 0) &&
            ((D_800C3E78 + 1) == *((volatile u8 *)var_v1 + 0x65))) {
            *(volatile s32 *)((volatile u8 *)var_v1 + 0x218) = 0;
            *(volatile s8 *)((volatile u8 *)var_v1 + 0x232) = (s8)D_800D1580;
        }
        if ((*(volatile s32 *)((volatile u8 *)var_v1 + 0x32C) != 0) &&
            ((D_800C3E78 + 1) == *((volatile u8 *)var_v1 + 0x391))) {
            *(volatile s32 *)((volatile u8 *)var_v1 + 0x544) = 0;
            *(volatile s8 *)((volatile u8 *)var_v1 + 0x55E) = (s8)D_800D1580;
        }
        if ((*(volatile s32 *)((volatile u8 *)var_v1 + 0x658) != 0) &&
            ((D_800C3E78 + 1) == *((volatile u8 *)var_v1 + 0x6BD))) {
            *(volatile s32 *)((volatile u8 *)var_v1 + 0x870) = 0;
            *(volatile s8 *)((volatile u8 *)var_v1 + 0x88A) = (s8)D_800D1580;
        }
        if ((*(volatile s32 *)((volatile u8 *)var_v1 + 0x984) != 0) &&
            ((D_800C3E78 + 1) == *((volatile u8 *)var_v1 + 0x9E9))) {
            *(volatile s32 *)((volatile u8 *)var_v1 + 0xB9C) = 0;
            *(volatile s8 *)((volatile u8 *)var_v1 + 0xBB6) = (s8)D_800D1580;
        }
        var_v1 += 0x32C;
    } while (var_v1 != &D_800D121C);
}
#endif /* CONKER_DEFERRED_CANDIDATE func_150727F0 */
...
#if 0 /* CONKER_DEFERRED_CANDIDATE func_15072F10 CURRENT (261) */
void func_15072F10(void) {
    ...
    angle = (s16)(*(s8 *)(D_800D154C + 0x1D1) * 0xC8);
    temp_v0 = *(void **)(D_800D154C + 0x31C);
    *(s16 *)((u8 *)temp_v0 + 0x24) -= 1;
    func_1505A184(
        (*(u16 *)(D_800D154C + 0x7A) -
    ...
    sp4C = temp_ft1;
    temp_ft5 = (sp48 * D_8009A094) + *(f32 *)(D_800D154C + 0x1C);
    sp48 = temp_ft5;
    temp_ft4 = (sp44 * D_8009A094) + *(f32 *)(D_800D154C + 0x18);
    sp44 = temp_ft4;
    func_150E1570(D_800D154C,
                  *(f32 *)(D_800D154C + 0x14),
                  *(f32 *)(D_800D154C + 0x18) +
                      (f32)*(s16 *)(D_800D154C + 0xD6),
                  *(f32 *)(D_800D154C + 0x1C),
                  temp_ft1, temp_ft4, temp_ft5, D_800C3E78, 0x12);
}
#endif /* CONKER_DEFERRED_CANDIDATE func_15072F10 */
...
#if 0 /* CONKER_DEFERRED_CANDIDATE func_1507490C CURRENT (415) */
void func_1507490C(void) {
    ...
    offset = (temp_v1 - 0x64) & 0xFF;
    temp_v1_2 = (offset * 0x32C) + (u8 *)&D_800CC2D0;
    if (temp_v1 != 0) {
        if ((s32) *(u8 *)((u8 *)temp_v1_2 + 0x13D) >= 0x64) {
            s32 value = D_800D1580;
            *(s32 *)((u8 *)temp_v1_2 + 0x218) = 0;
            *(s8 *)((u8 *)temp_v1_2 + 0x104) = 0;
            *(s8 *)((u8 *)temp_v1_2 + 0x232) = (s8) value;
        }
    }
}
...
void func_15074980(void) {
    ...
    if (D_8008FD8C > 0) {
        ...
        do {
            if (func_1505A72C(D_800D154C, (u8 *)var_s0) < temp_fs0) {
...
typedef struct Game981E0BeamActor {
    u8 pad0[0x14];
    f32 field14;
    f32 field18;
    f32 field1C;
...
typedef struct Game981E0BeamEvent {
    s32 kind;
    u8 pad4[0x1C6];
    u8 field1CA;
} Game981E0BeamEvent;
...
void func_15074C80(Game981E0BeamActor *arg0, Game981E0BeamEvent *arg1, s32 arg2) {
    s32 effect;

    if (arg0->field278 == 0x11) {
        func_151942E8((s32)arg0, (s32)arg1, arg2);
    }
    if ((arg0->field278 == 2) || (arg0->field278 == 0x12) || (arg0->field278 == 3) || (arg0->field278 == 6)) {
        if (arg1->field1CA == 0) {
            if (arg0->field278 == 2) {
                effect = 0x2A;
            } else if (arg0->field278 == 0x12) {
                effect = 0x2F;
            } else if (arg0->field278 == 3) {
                effect = 0x39;
            } else {
                effect = 0x51;
            }
            func_150335C8(arg0, arg1, effect, 0xC, 1, 0);
        }
        arg0->field1CA = 0;
    }
    if (arg1->kind == 0x19) {
        func_15166118((s32)(256.0f - (func_150484A0(arg0->field20, arg0->field3C) * D_8009A104)), 0xC0 - ((s32)arg0->field76 >> 8), (s32)arg0->field14, (s32)arg0->field18, (s32)arg0->field1C, 0x10, 0x14, 0, 0xFF, 0);
    }
}
